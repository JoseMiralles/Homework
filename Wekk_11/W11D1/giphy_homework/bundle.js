...
function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function render() {
      ...
      }, "search"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, this.props.giphys.map(function (url) {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mapStateToProps, mapDispathToProps)(_giphys_search__WEBPACK_IMPORTED_MODULE_1__["default"]));
...
var giphysReducer = function giphysReducer() {
  ...
  switch (action.type) {
    case _actions_giphy_actions__WEBPACK_IMPORTED_MODULE_1__["RECEIVE_SEARCH_GIPHYS"]:
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  var url = "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=").concat(_keys__WEBPACK_IMPORTED_MODULE_0__["giphyKey"], "&limit=2");
  return $.ajax({
    method: "GET",
    url: url
  });
